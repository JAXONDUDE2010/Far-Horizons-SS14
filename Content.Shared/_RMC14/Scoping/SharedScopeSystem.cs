...
// using Content.Shared._RMC14.Attachable.Events; // Far Horizons
// using Content.Shared._RMC14.Emplacements; // Far Horizons
...
// using Content.Shared._RMC14.Overwatch; // Far Horizons
...
public abstract partial class SharedScopeSystem : EntitySystem
{
    ...
    {
        // Far Horizons Start - Remote Weapon Controller
    ...
    private bool CanScopePopup(Entity<ScopeComponent> scope, EntityUid user)
    {
        ...
        // Far Horizons Start - Remove this, its used for RMC cameras
    ...
    public virtual bool Unscope(Entity<ScopeComponent> scope)
    {
        ...
        // Far Horizons Start - Attachments code
