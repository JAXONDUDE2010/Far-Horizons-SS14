signal-port-name-vitals-monitor-sender = Vitals Monitor
signal-port-description-vitals-monitor-sender = Receiving info about patient condition from a Medical or Stasis Bed.
