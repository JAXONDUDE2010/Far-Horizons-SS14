thief-role-greeting-human =
    ...
    You were forcibly given a pacifism implant by the Concord Frontier Authority after your last arrest, but that can't stop you from getting your fix by any means necessary.
