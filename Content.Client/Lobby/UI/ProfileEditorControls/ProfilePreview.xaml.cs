...
public sealed partial class ProfilePreview : BoxContainer
{
    ...
    /// <param name="factionMan">Passed in dependency</param>
    /// Far Horizons
    public void Initialize(HumanoidProfileEditor profileEditor, IEntityManager entMan, IClientPreferencesManager prefMan, IPrototypeManager protoMan, ISharedPlayerManager playerMan, ISharedFactionManager factionMan)
    {
