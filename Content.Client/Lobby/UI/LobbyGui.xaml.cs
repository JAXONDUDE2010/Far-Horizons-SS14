...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class LobbyGui : UIScreen
    {
        ...
        public LobbyGui()
        {
            ...
            //Far Horizons start, idea taken from StarLight
            _serverName = _configurationManager.GetCVar(FHCCVars.ServerName);
            _configurationManager.OnValueChanged(FHCCVars.ServerName, OnServerNameChanged, true);
