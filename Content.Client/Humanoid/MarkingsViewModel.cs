...
public sealed class MarkingsViewModel
{
    ...
    private readonly Dictionary<ProtoId<MarkingPrototype>, bool> _previousGlowing = new(); // Far Horizons
        ...
        ProtoId<MarkingPrototype> markingId)
    {
        ...
        var newMarking = new Marking(markingId, colors, glowing) { Forced = AnyEnforcementsLifted };
