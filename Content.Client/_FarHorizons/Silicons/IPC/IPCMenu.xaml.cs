...
public sealed partial class IPCMenu : FancyWindow
{
    ...
    private void UpdateWindow()
    {
        ...
        FullText = PrintConsole(LastKnownState.ToString(), LastKnownBattery, LastKnownCharge, eyeDamage, bloodLevel, Brain, damage);
        ...
        ChargeLabel.Text = Loc.GetString("borg-ui-charge-label",
            ("charge", (int) MathF.Round(LastKnownCharge * 100)));
    }

    public void UpdateState(IPCBuiState state)
    {
        LastKnownBattery = state.HasBattery;
        LastKnownCharge = state.ChargePercent;
        LastKnownState = state.MobState;
    }

    private static string PrintConsole(string currentState, bool hasBattery, float batteryCharge, int eyeDamage, float bloodLevel, IPCBrainHolderComponent? brain, DamageSpecifier damageSpec)
    {
